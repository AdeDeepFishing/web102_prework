...
let unfundedGamesString = numUnfundedGames === 1 ? "game" : "games";

// create a new DOM element containing the template string and append it to the description container
let unfundedGamesElement = document.createElement("p");
unfundedGamesElement.textContent = `We currently have ${numUnfundedGames} unfunded ${unfundedGamesString}.`;
...
let topGameName = document.createElement("h2");
